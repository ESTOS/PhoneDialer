...
//DWORD (size = 4) Repräsentierung der ActiveAddress Flags (UserContainer NSX)
#define ECSTADEVSPECIFICELEMENT_ACTIVEADDRESSFLAGS		0x00000005
...
#define ECSTA_ACTIVEADDRESSFLAG_DYNAMIC_ADDRESS			0x00000001
...
#define ECSTA_ACTIVEADDRESSFLAG_CALLADDRESSINVALID		0x00000002
//! Diese Adresse kann mit setactiveAddress an die PBX (NSX) weitergegeben werden
#define ECSTA_ACTIVEADDRESSFLAG_ALLOWACTIVEADDRESS		0x00000004
//! Ist diese Adresse ist die ActiveAddress (NSX)
#define ECSTA_ACTIVEADDRESSFLAG_IS_ACTIVEADDRESS		0x00000008
