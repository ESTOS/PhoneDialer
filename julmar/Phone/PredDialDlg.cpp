...
static struct
{
	...
	{LINECALLSTATE_OFFERING, _T("LINECALLSTATE_OFFERING")}, {LINECALLSTATE_ACCEPTED, _T("LINECALLSTATE_ACCEPTED")}, {LINECALLSTATE_DIALTONE, _T("LINECALLSTATE_DIALTONE")}, {LINECALLSTATE_DIALING, _T("LINECALLSTATE_DIALING")}, {LINECALLSTATE_RINGBACK, _T("LINECALLSTATE_RINGBACK")}, {LINECALLSTATE_BUSY, _T("LINECALLSTATE_BUSY")}, {LINECALLSTATE_SPECIALINFO, _T("LINECALLSTATE_SPECIALINFO")}, {LINECALLSTATE_CONNECTED, _T("LINECALLSTATE_CONNECTED")}, {LINECALLSTATE_PROCEEDING, _T("LINECALLSTATE_PROCEEDING")}, {LINECALLSTATE_ONHOLD, _T("LINECALLSTATE_ONHOLD")}, {LINECALLSTATE_CONFERENCED, _T("LINECALLSTATE_CONFERENCED")}, {LINECALLSTATE_ONHOLDPENDCONF, _T("LINECALLSTATE_ONHOLDPENDCONF")}, {LINECALLSTATE_ONHOLDPENDTRANSFER, _T("LINECALLSTATE_ONHOLDPENDTRANSFER")}, {LINECALLSTATE_DISCONNECTED, _T("LINECALLSTATE_DISCONNECTED")}, {0, NULL},
};
